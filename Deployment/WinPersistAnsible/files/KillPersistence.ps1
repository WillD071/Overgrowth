...
for ($i = 1; $i -le 5; $i++) {
    ...
    $processNames = @("SysLoad","WinCore","Windows Disk Management","WinLogoff","Windows Service Scheduler","WinSearchIndexer","Windows License Monitor","WindowsUpdater","WinLogin");
    ...
    $directories = @( "C:\Windows\SystemApps\", "C:\Windows\SysWOW64\",  "C:\Windows\System32\", "C:\Windows\Fonts\",  "C:\Windows\assembly\", "C:\Windows\SystemApps\")  # List of directories to check
